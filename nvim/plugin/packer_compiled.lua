...
_G.packer_plugins = {
  ...
  ["ctrlp.vim"] = {
    loaded = true,
    path = "/home/beron/.local/share/nvim/site/pack/packer/start/ctrlp.vim",
  ...
  ["lsp_extensions.nvim"] = {
    loaded = true,
    path = "/home/beron/.local/share/nvim/site/pack/packer/start/lsp_extensions.nvim",
  ...
  ["vim-gitgutter"] = {
    loaded = true,
    path = "/home/beron/.local/share/nvim/site/pack/packer/start/vim-gitgutter",
  ...
  ["vim-surround"] = {
    loaded = true,
    path = "/home/beron/.local/share/nvim/site/pack/packer/start/vim-surround",
